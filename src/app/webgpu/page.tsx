...
export default function WebGPU() {
  ...
  function handleTranslationXChange(event: ChangeEvent<HTMLInputElement>) {
    setTranslationX(Number(event.target.value))
  }

  function handleTranslationYChange(event: ChangeEvent<HTMLInputElement>) {
    setTranslationY(Number(event.target.value))
  }
    ...
    >
      ...
      >
        ...
        <input
          type='range'
          value={translationX}
          onChange={handleTranslationXChange}
          style={{
            accentColor: 'wheat',
            width: 300,
          }}
        ...
        <input
          type='range'
          value={translationY}
          onChange={handleTranslationYChange}
          style={{
            accentColor: 'wheat',
            width: 300,
          }}
